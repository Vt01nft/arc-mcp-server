...
export async function arcSendUsdc(args) {
    ...
    }).catch(() => 60000n); // fallback estimate
    ...
    if (balance < amountRaw) {
        throw new Error(`Insufficient USDC balance. Have: ${formatUsdc(balance, USDC_DECIMALS)}, need: ${args.amount}`);
    }
